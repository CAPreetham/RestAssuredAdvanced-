...
public class jsonReqres {
	...
	public static void main(String[] args) {
		...
		File jsonArrayFile = new File(System.getProperty("user.dir")+"/src/test/java/jsonpathclass/jsonArraySyntaxDemo.json");
		...
		System.out.println("First name of first female employee : "+jsonPath.getString("findAll{it.gender == 'Female'}.first_name"));
		...
		System.out.println("First name of all employees whose id is 5 or more but less than 8 : " + jsonPath.getList("findAll{it.id > gt;= 5 &amp; it.id &lt; 8}.first_name"));
		
		// We can also use or (|) operator
		System.out.println("First name of all employees whose id is greater than 9 or gender is female : " + jsonPath.getList("findAll{it.id > gt;= 9 | it.gender == 'Female'}.first_name"));
